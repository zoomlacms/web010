        ...
        try
        {
            switch (action)
            {
                ...
                case "Cloud_Doc":
                    ...
                    uploadPath = context.Server.UrlDecode(SiteConfig.SiteOption.UploadDir + "YunPan/" + mu.UserName + mu.UserID + "/");
                    break;
                case "design"://动力模块
                    {
            ...
            else if (action.Equals("Cloud_Doc"))
            {
                ...
                {
                    string icourl = SiteConfig.SiteOption.UploadDir + "YunPan/" + mu.UserName + mu.UserID + "/";
