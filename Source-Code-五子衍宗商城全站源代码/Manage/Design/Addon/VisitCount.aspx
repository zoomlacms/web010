<%@ page language="C#" autoeventwireup="true" inherits="Manage_Design_Addon_VisitCount, App_Web_tdpepvbc" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div id="Detail_Div" runat="server">
            <table class="table table-striped table-bordered table-hover">
                ...
                <ZL:Repeater ID="Detail_RPT" BoxType="dp" runat="server" PageSize="20" PagePre="<tr id='page_tr'><td colspan='6' id='page_td'>" PageEnd="</td></tr>" OnItemCommand="Detail_RPT_ItemCommand" >
                    <ItemTemplate>
                        <tr>
                            <td><a href="VisitCount.aspx?skey=<%#Eval("InfoTitle") %>"  title="浏览"><%#Eval("InfoTitle") %></a></td>
                            <td><%#GetUser() %></td>
                            <td><%#GetType() %></td>
