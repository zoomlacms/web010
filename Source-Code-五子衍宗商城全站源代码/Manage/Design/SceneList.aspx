<%@ page language="C#" autoeventwireup="true" inherits="Manage_Design_SceneList, App_Web_ng3smgww" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                        ...
                        <li class="padding5">
                            <div class="Template_box">
                                ...
                                <div>
                                    ...
                                    <span class="cdate" title="创建时间"><%#Eval("CDate","{0:yyyy/M/d HH:mm}") %><a class="temp_pre" href='/h5/<%#Eval("ID") %>' title="浏览场景" target="_blank"><i class="fa fa-globe"></i></a></span>
                                </div>
                                ...
                                <span <%=Status ==-1 ? "hidden":"" %>>
                                    <ul class="list_unstyled">
                                        ...
                                        <li class="temp_del">
                                            <a class="precode" href="javascript:;" data-sid="<%#Eval("ID") %>" data-guid='<%#Eval("Guid") %>' target="_blank"><i class="fa fa-qrcode"></i></a>
                                        </li>
                                        <li class="temp_del">
        ...
        pop.bindEvent = function ($items) {
            $items.popover({
                animation: true, placement: 'top', title: "扫描二维码浏览", content: function () {
                    return '<div><img src="/common/common.ashx?url=<%=ZoomLa.Components.SiteConfig.SiteInfo.SiteUrl+"/h5/"%>' + pop.sid + '" style="width:150px;height:150px;"></div>';
                }, html: true, trigger: 'manual',
            }).hover(function () {
                var $uinfo = $(this);
                pop.sid = $uinfo.data("sid");
                $uinfo.popover('show');
            }, function () {
               $(this).popover('hide');
            })
