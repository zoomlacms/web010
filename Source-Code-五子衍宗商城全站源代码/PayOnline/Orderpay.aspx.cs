        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (orderDT != null && orderDT.Rows.Count > 0)
                {
                    ...
                    TotalMoney_L.Text = price.ToString("f2") + " + " + fare.ToString("f2") + " - " + arrive.ToString("f2") + "-" + (point * 0.01).ToString("f2") + "(" + point + ")" + " = " + allamount.ToString("f2");
                    TotalMoney_L.Text = TotalMoney_L.Text + "　(商品总价+运费-优惠券-积分兑换=总额)";
