<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_se_conf, App_Web_aazbrand" masterpagefile="~/Design/Master/Edit.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<%@ Register Src="~/Manage/I/ASCX/SFileUp.ascx" TagPrefix="ZL" TagName="SFileUp" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
<link type="text/css" href="/dist/css/bootstrap-switch.min.css" rel="stylesheet" />
<title>场景设置</title></asp:Content>
...
<div ng-controller="ZLCtrl">
    ...
    <div class="tab-content padding0">
        ...
        <div id="Tabs1" class="tab-pane">
            <table class="table table-bordered">
                <tr>
                    <td><label>涂抹特效</label></td>
                    <td><input type="checkbox" ng-model="eraser.able" id="eraser_chk"/></td>
                </tr>
                <tbody class="eraser_tbody">
                    ...
                    <tr>
                        <td>透明度</td>
                        <td>
                            <div class="setting-row"><div id="opacity_slider" class="slider_min"></div>
                            <input type="text" id="opacity_t" class="inputer min" /></div>
                        </td>
                    </tr>
                    <tr>
                        <td>涂抹比例</td>
                        <td>
                            <div class="setting-row"><div id="progscale_slider" class="slider_min"></div>
                            <input type="text" id="progscale_t" class="inputer min" /></div>
                        </td>
                    </tr>
                </tbody>
            </table>
