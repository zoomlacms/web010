<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_AddDomain, App_Web_lcmdep3h" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
