<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Cloud_CloudManage, App_Web_yktavja5" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <td align="left">
                        ...
                        <span class="hoverDiv" style="display:none;">
		                 <%#GetOP() %>
                            ...
                            OnClientClick="if(!this.disabled) return confirm('确定要删除吗？');" runat="server"><span class='fa fa-trash-o' title='删除'></span></asp:LinkButton>
                        </span>
			        </td>
                    </td>
...
<li><a href="/Mis/ke/DailyPlan.aspx"><i class="fa fa-calendar" style="background:#990000"></i><span>日程安排</span></a></li>
<li><a href="MySubscription.aspx"><i class="fa fa-rss" style="background:#28b779"></i><span>订阅管理</span></a></li>
<li><a href="Info/Listprofit.aspx"><i class="fa fa-usd" style="background:#a43ae3"></i><span>财务管理</span></a></li>
...
<li><a href="Info/DredgeVip.aspx"><i class="fa fa-credit-card-alt" style="background:#CC3366"></i><span class="span_xs">VIP卡</span></a></li>
<li><a href="PrintServer/ImageList.aspx"><i class="fa fa-paint-brush" style="background:#27a9e3"></i><span>FLEX涂鸦</span></a></li>
<li><a href="PrintServer/Project/ProjectList.aspx"><i class="fa fa-th-large" style="background:#990000"></i><span>项目管理</span></a></li>
<li><a href="Survey/SurveyAll.aspx"><i class="fa fa-list-alt" style="background:#999"></i><span>问卷投票</span></a></li>
<li><a href="/Try/Default.aspx" target="_blank"><i class="fa fa-headphones" style="background:#6699CC"></i><span>在线试戴</span></a></li> 
<li><a href="/Plugins/Domain/Domname.aspx?Page=7" target="_blank"><i class="fa fa-globe" style="background:#852b99"></i><span>IDC管理</span></a></li> 
<li><a href="/Mis/" target="_blank"><i class="fa fa-tags" style="background:#1FA67A"></i><span class="span_xs">MIS管理系统</span></a></li> 
<li><a href="UserFunc/Watermark/" target="_blank"><i class="fa fa-barcode" style="background:#22afc2"></i><span class="span_xs">授权证书生成</span></a></li>    
</ul> 
</div>  
</div>
</asp:Content>
